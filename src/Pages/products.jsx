...
function ProductsPage() {
  ...
  // getProducts and setProducts di api
  useEffect(() => {
    getProducts((data) => {
      setProducts(data);
    });
  ...
  return (
    <Fragment>
      <div className="text-md font-bold text-white flex justify-end bg-blue-500 px-10 h-20 p-5">
        Selamat Datang {email}
        <Button
          className="bg-black hover:bg-gray-500 text-white font-bold py-2 px-4 rounded ml-5"
          onClick={handleLogout}
        >
          Logout
        </Button>
      </div>
      <div className="text-3xl font-bold text-white flex justify-center bg-black mt">
